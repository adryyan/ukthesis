...
\begin{enumerate}[nosep]
    \item \texttt{lualatex thesis.tex}
    \item \texttt{biber thesis.bcf}
    \item \texttt{lualatex thesis.tex}
    \item \texttt{lualatex thesis.tex}
\end{enumerate}
...
\texttt{latexmk --lualatex thesis.tex}
...
\texttt{latexmk --output-directory=build --lualatex thesis.tex}


\section{Erstellen des Ausgabedokuments mit Overleaf}
Der Kompiliervorgang dieser Vorlage dauert zu lange für die freie Version von Overleaf und bricht vorzeitig ab.

Allerdings kann Overleaf Premium kostenlos mit einem IEEE Collabratec Account aktiviert werden:

\begin{center}
    \ttfamily\url{https://journals.ieeeauthorcenter.ieee.org/create-your-ieee-journal-article/authoring-tools-and-templates/tools-for-ieee-authors/}
\end{center}

Dies ermöglicht zusätzlich, dass eingeladene Personen das Dokument zum Korrekturlesen bearbeiten und kommentieren können.
